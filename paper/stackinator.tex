...
\end{figure}
A user may leave the default \craympich version, but override \lst{depends} section to only change drivers, or override the \lst{mpi} spec entirely and provide custom versions of any or all of the dependencies
